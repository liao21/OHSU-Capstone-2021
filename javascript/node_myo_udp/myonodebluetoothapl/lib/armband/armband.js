...
var EulerAngle = require('../util/eulerAngle');
        ...
        if(this.isConnected()){
            ...
            this.communicator.initStart(function(eventData){
                ...
                if(eventData.orientation){
                    ...
                    let eulerAngle = new EulerAngle(eventData.orientation.x, eventData.orientation.y, eventData.orientation.z, eventData.orientation.w);

                    this.emit('eulerangle', eulerAngle.getAngles());
                }
                if(eventData.accelerometer){
                    // TODO: Sample EventData
                    this.emit('accelerometer',eventData.accelerometer)
                }
